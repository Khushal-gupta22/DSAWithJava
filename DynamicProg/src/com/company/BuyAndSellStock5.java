...
//                sellingDate++;
//            } else {
//                profits.add((arr[sellingDate] - arr[buyingDate]));
//                buyingDate = sellingDate = i;
//            }
//        }
//
//        profits.add((arr[sellingDate] - arr[buyingDate]));
//        int secondLargest =  profits.get(0);
...
//            }
//            if(profits.get(i) > secondLargest ) {
...
//
        // above is the approach 1 where you store the profits of all the peaks in an arraylist and sum out the two maximum profits. most simple and effective imo
        ...
        maxProfitIfBoughtToday = maxAfterToday - arr[i];
            if (maxProfitIfBoughtToday > dpMaxProfitIfBoughtTodayOrAfterToday[i+1]) {
                dpMaxProfitIfBoughtTodayOrAfterToday[i] = maxProfitIfBoughtToday;
            } else {
